...
/**
 * Use case to get selfies for a specific month and year
 */
class GetSelfiesByMonthUseCase @Inject constructor(
    private val repository: SelfieRepository
) {
    operator fun invoke(month: Int, year: Int): Flow<List<SelfieEntry>> {
